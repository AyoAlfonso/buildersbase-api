...
var CockroachQueryRunner = /** @class */ (function (_super) {
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        table.columns
                            ...
                            upQueries.push("CREATE SEQUENCE " + _this.buildSequenceName(table, column));
                            downQueries.push("DROP SEQUENCE " + _this.buildSequenceName(table, column));
                        });
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        table.columns
                            .filter(function (column) { return column.isGenerated && column.generationStrategy === "increment"; })
                            .forEach(function (column) {
                            upQueries.push("DROP SEQUENCE " + _this.buildSequenceName(table, column));
                            downQueries.push("CREATE SEQUENCE " + _this.buildSequenceName(table, column));
                        });
                        return [4 /*yield*/, this.executeQueries(upQueries, downQueries)];
                    case 4:
                        _a.sent();
    ...
    CockroachQueryRunner.prototype.clearDatabase = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var schemas, schemaNamesString, selectDropsQuery, dropQueries, selectSequenceDropsQuery, sequenceDropQueries, error_1, rollbackError_1;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
     ...
     */
    CockroachQueryRunner.prototype.escapeTableName = function (target, disableEscape) {
        var tableName = target instanceof Table ? target.name : target;
